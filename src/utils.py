...
Description:
Program that calculates and visualizes various evaluation metrics for classification models,
such as confusion matrix, accuracy, precision, recall, F1 score, ROC curve, and calibration
curve. It also provides detailed plots for probability distributions and classification 
performance assessment based on user-defined thresholds and positive labels.
"""
