...
Description:
Program that implements a logistic regression model from scratch, including options for L1 (Lasso),
L2 (Ridge), and ElasticNet regularization. The class provides methods for fitting the model to data,
predicting class labels, calculating probabilities, and evaluating model performance using gradient
descent optimization. Additionally, it supports verbose output for iterative training progress.
"""
