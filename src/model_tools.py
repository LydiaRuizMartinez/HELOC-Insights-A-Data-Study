...
Description:
Program that provides visualization tools for machine learning models and data analysis,
incorporating features such as model cross-validation error plotting over hyperparameter
grids, dot plots for comparing model scores, and customized dataframe plotting analogous 
to seaborn's pairplot. It also includes classes for transforming data using specified
formulas and selecting features for model training, enhancing flexibility in data 
